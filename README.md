...
* Download the binary file from: https://github.com/large-scale-gxe-methods/GEM/releases/download/v1.5.1/GEM_1.5.1_static_Intel.
* Change the permission: chmod a+x GEM_1.5.1_static_Intel
